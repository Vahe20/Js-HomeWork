...
export function selectPiecePromotion(chessBoard: ChessBoard, row: number, col: number) {
    ...
    document.getElementById(`promote_btn-queen`)?.addEventListener('click', (event) => {
    ...
    document.getElementById(`promote_btn-rook`)?.addEventListener('click', (event) => {
        chessBoard.board[row]![col] = new Rook(currentPlayer, 'rook', { row, col }, `images/${currentPlayer}_rook.png`);
        promote.style.transform = 'scale(0)';
        Render.renderBoard(chessBoard);
    });

    document.getElementById(`promote_btn-bishop`)?.addEventListener('click', (event) => {
        chessBoard.board[row]![col] = new Bishop(currentPlayer, 'bishop', { row, col }, `images/${currentPlayer}_bishop.png`);
        promote.style.transform = 'scale(0)';
        Render.renderBoard(chessBoard);
    });

    document.getElementById(`promote_btn-knight`)?.addEventListener('click', (event) => {
