...
export declare function selectPiecePromotion(): void;
export declare function getKing(chessBoard: ChessBoard, color: Types.typePlaceColor): import("./chessPiece/chessPiece.js").ChessPiece | undefined;
