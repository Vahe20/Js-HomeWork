...
export function selectPiecePromotion(chessBoard, row, col) {
    ...
    (_a = document.getElementById(`promote_btn-queen`)) === null || _a === void 0 ? void 0 : _a.addEventListener('click', (event) => {
        chessBoard.board[row][col] = new Queen(currentPlayer, 'queen', { row, col }, `images/${currentPlayer}_queen.png`);
        promote.style.transform = 'scale(0)';
        Render.renderBoard(chessBoard);
    });
    (_b = document.getElementById(`promote_btn-rook`)) === null || _b === void 0 ? void 0 : _b.addEventListener('click', (event) => {
        chessBoard.board[row][col] = new Rook(currentPlayer, 'rook', { row, col }, `images/${currentPlayer}_rook.png`);
        promote.style.transform = 'scale(0)';
        Render.renderBoard(chessBoard);
    });
    (_c = document.getElementById(`promote_btn-bishop`)) === null || _c === void 0 ? void 0 : _c.addEventListener('click', (event) => {
        chessBoard.board[row][col] = new Bishop(currentPlayer, 'bishop', { row, col }, `images/${currentPlayer}_bishop.png`);
        promote.style.transform = 'scale(0)';
        Render.renderBoard(chessBoard);
    });
    (_d = document.getElementById(`promote_btn-knight`)) === null || _d === void 0 ? void 0 : _d.addEventListener('click', (event) => {
        chessBoard.board[row][col] = new Knight(currentPlayer, 'knight', { row, col }, `images/${currentPlayer}_knight.png`);
        promote.style.transform = 'scale(0)';
        Render.renderBoard(chessBoard);
    });
}
